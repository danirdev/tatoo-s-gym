        ...
        <section className="bg-black py-20 relative overflow-hidden">
            ...
            <div className="max-w-7xl mx-auto px-4 relative z-10">
                <div className="flex flex-col items-center gap-12">
                    ...
                    <motion.a
                        href="https://www.instagram.com/reel/DKGUtvqxBc-/"
                        target="_blank"
                    ...
                    >
                        {/* Header Mockup */}
                        <div className="flex items-center gap-3 p-4 bg-gradient-to-b from-black/80 to-transparent absolute top-0 w-full z-20">
                        ...
                        {/* Footer Mockup */}
                        <div className="p-4 bg-gradient-to-t from-black/90 to-transparent absolute bottom-0 w-full z-20">
